...
.calendar-cell.calendar-cell-empty { background: transparent; border-color: transparent; }
.calendar-cell.calendar-cell-today { border-color: var(--pri); border-width: 2px; }
.calendar-cell-date { font-size: 12px; font-weight: 600; color: var(--text); }
.calendar-cell-dots { display: flex; flex-wrap: wrap; gap: 3px; }
.calendar-cell.calendar-has-items {
  cursor: pointer;
  transition: background 0.12s, box-shadow 0.12s;
}
.calendar-cell.calendar-has-items:hover { background: #f8f9fd; box-shadow: var(--shadow-sm); }
.calendar-cell-count { font-size: 11px; color: var(--text-muted); margin-top: auto; }
...
<header class="topbar">
  ...
  <div class="d-flex align-items-center gap-2">
    ...
    <button id="vacuumBtn" class="btn btn-sm btn-outline-light">
      <i class="bi bi-hdd"></i> DB 최적화
    </button>
...
<main class="container-fluid py-4">
  ...
  <div class="d-flex justify-content-center mb-3">
    <button id="quickReplaceBtn" class="btn btn-sm btn-outline-primary">
      <i class="bi bi-funnel"></i> 필터링 교체 등록
    </button>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <label class="form-label">메일에 포함할 항목 (체크 여부와 순서를 지정)</label>
        <ul id="mailReportSectionList" class="list-group mb-3"></ul>
...
<!-- 필터링 교체 등록 모달 -->
<div class="modal fade" id="quickReplaceModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="bi bi-funnel"></i> 필터링 교체 등록</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <form id="quickReplaceForm">
          <div class="mb-2">
            <label class="form-label">설비</label>
            <select id="quickReplaceEquipment" class="form-select" required>
              <option value="">선택하세요</option>
            </select>
          </div>
          <div class="mb-2">
            <label class="form-label">유닛</label>
            <select id="quickReplaceUnit" class="form-select" required disabled>
              <option value="">먼저 설비를 선택하세요</option>
            </select>
          </div>
          <div class="mb-2">
          ...
          <div class="mb-2">
            ...
            <input type="date" class="form-control" id="quickReplaceDate" required>
          </div>
          <button type="submit" class="btn btn-primary w-100 mt-2">등록</button>
        </form>
      </div>
    </div>
  </div>
...
<main class="container-fluid py-4">
  ...
  <div class="legend mb-3">
    <span class="legend-item"><span class="dot dot-overdue"></span> 교체 필요</span>
    <span class="legend-item"><span class="dot dot-soon"></span> 교체 임박</span>
    <span class="legend-item"><span class="dot dot-ok"></span> 정상(예정)</span>
  </div>

  <div class="d-flex justify-content-center gap-2 mb-3">
    <button id="viewListBtn" class="btn btn-sm btn-primary">
      <i class="bi bi-list-ul"></i> 목록
    </button>
    <button id="viewCalendarBtn" class="btn btn-sm btn-outline-primary">
  ...
  <div id="calendarView" class="d-none">
    <div class="d-flex align-items-center justify-content-center gap-3 mb-3">
      <button id="calPrevBtn" class="btn btn-sm btn-outline-secondary"><i class="bi bi-chevron-left"></i></button>
      <h5 id="calMonthLabel" class="mb-0"></h5>
      <button id="calNextBtn" class="btn btn-sm btn-outline-secondary"><i class="bi bi-chevron-right"></i></button>
    </div>
    <div id="calWeekdays" class="calendar-weekdays"></div>
...
<div class="modal fade" id="calDayModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="calDayModalTitle"></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <div id="calDayModalList" class="alerts-list"></div>
      </div>
    </div>
  </div>
</div>
